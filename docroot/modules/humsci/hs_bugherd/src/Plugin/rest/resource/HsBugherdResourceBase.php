...
abstract class HsBugherdResourceBase extends ResourceBase {
  ...
  //
  //  /**
  //   * Get the original Jira key if they issue has moved to a new project.
  //   *
  //   * @param array $jira_webhook_data
  //   *   Webhook data.
  //   *
  //   * @return string
  //   *   Original key or current key if it hasn't changed.
  //   */
  //  public static function getOriginalJiraKey(array $jira_webhook_data) {
  //    if (!empty($jira_webhook_data['changelog']['items'])) {
  //      foreach ($jira_webhook_data['changelog']['items'] as $change) {
  //        if ($change['field'] == 'Key') {
  ...
  //    }
  //
  //    return self::getCurrentJiraKey($jira_webhook_data);
  //  }
  //
  //  /**
  //   * Get the current Jira key from the webhook data.
  //   *
  //   * @param array $jira_webhook_data
  //   *   Webhook data.
  //   *
  ...
  //   *   The current key.
  //   */
  //  public static function getCurrentJiraKey(array $jira_webhook_data) {
  //    return $jira_webhook_data['issue']['key'];
  //  }
  //
  //  /**
  //   * {@inheritdoc}
  ...
  //    $issue_key = self::getOriginalJiraKey($jira_data);
  ...
  //          $updates = [
  //            'status' => $new_status,
  //            'external_id' => self::getCurrentJiraKey($jira_data),
  //          ];
