...
class UniqueRequirementTypeConstraint extends Constraint {
   ...
   * @var string
   */
  public string $duplicate_colour = 'This colour is already used by another requirement type. Each requirement type must have a unique colour.';
   ...
   * @var string
   */
  public string $duplicate_name = 'This name is already used by another requirement type. Each requirement type must have a unique name.';
