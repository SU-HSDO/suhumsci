...
The HS SiteImprove module provides integration between Drupal and the [SiteImprove API](https://api.us.siteimprove.com/v2/documentation). This module serves as a foundation for various SiteImprove features within your Drupal site, making it easier for content editors to access SiteImprove data directly from the Drupal interface.
