...
if (EnvironmentDetector::isLocalEnv() && !InstallerKernel::installationAttempted()) {
  ...
  $ignored_entities = $config_ignore['ignored_config_entities'] ?? [];
  $config['config_ignore.settings']['ignored_config_entities'] = $ignored_entities + array_fill(0, 50, 'foo.bar.baz');
}
