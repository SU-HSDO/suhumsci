...
| hb-clear                  | Used for clear floats in a block and prevent content to wrap around it        |        -        |
...
| hb-timeline\_\_collapsed | Makes the Vertical Timeline in the View use the Collapsed Vertical Timeline Variant |       ✅        |
...
- 41.7% (5 columns) for horizontal and structured cards, once the card itself is wider than 350px
